...
<div class="row">
	...
	<form role="form" enctype="multipart/form-data" id="prosesverifikasiberkas" action="<?php echo base_url();?>index.php/admin/verifikasisiswa/prosesverifikasiberkas" method="post">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="box box-solid">
						...
						<div class="box-body">
							<table class="table table-striped">
								<tr>
									<td style="width: 45%;"><b>Nilai Rata-rata Kelulusan</b></td>
									<td>:</td>
						...
						<div class="box-body">
							<table class="table table-striped">
								...
								<tr>
									...
									<td>:</td>
									<td id="nilai_lulus" data-editor-field="nilai_lulus" style="width: 50%;"><?php echo $row->nomor_kip;?></td>
								</tr>
								<tr>
									<td colspan="3"></td>
								</tr>
								...
								<?php if ($row->masuk_bdt == 1) { ?>
									...
									<td>:</td>
									<td id="nilai_lulus" data-editor-field="nilai_lulus" style="width: 50%;"><?php echo $row->nomor_bdt;?></td>
								</tr>
								<tr>
									<td colspan="3"></td>
								</tr>
						...
						<div class="box-body">
							<table class="table table-striped">
								<tr>
									...
									<td>:</td>
									<td id="nilai_lulus" data-editor-field="nilai_lulus" style="width: 50%;"><?php echo $row->kebutuhan_khusus;?></td>
								</tr>
							</table>
						</div>
						<div class="box-footer">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<table id="tberkas" class="table table-striped" style="margin-bottom:0px !important;">
								<?php 
									foreach($berkas_fisik->getResult() as $row2):
									//clean up di sini karena data kotor untuk ppdb2019
									if ($row->punya_prestasi==0 && $row2->daftar_kelengkapan_id==8) {
										continue;
									}
								...
								?>
								<input type="hidden" id="orig_berkas_<?php echo $row2->dokumen_id;?>" name="orig_berkas_<?php echo $row2->dokumen_id;?>" value="<?php echo $row2->verifikasi; ?>">
								<input type="hidden" id="orig_catatan_<?php echo $row2->dokumen_id;?>" name="orig_catatan_berkas_<?php echo $row2->dokumen_id;?>" value="<?php echo $row2->catatan; ?>">
								<tr >
									<td>
										<div style="display: block; margin-bottom: 15px;"><b><?php echo $row2->nama; ?></b></div>
									</td>
									<td style="width: 50%">
										<div class="form-group" style="margin-bottom: 10px;">
											<label style="margin-right: 10px;">
												<input type="radio" id="berkas_<?php echo $row2->dokumen_id;?>" name="berkas_<?php echo $row2->dokumen_id;?>" class="flat-green verifikasi-dokumen"<?php if($row2->berkas_fisik==1){?> checked <?php }?> value="1" data-validation="required" data-validation-error-msg="Verifikasi berkas fisik <?php echo $row2->nama; ?>">
												SUDAH Diterima
											</label>
											<label>
												<input type="radio" id="berkas_<?php echo $row2->dokumen_id;?>" name="berkas_<?php echo $row2->dokumen_id;?>" class="flat-red verifikasi-dokumen"<?php if($row2->berkas_fisik==0{?> checked <?php }?> value="2" data-validation="required" data-validation-error-msg="Verifikasi berkas fisik <?php echo $row2->nama; ?>">
												BELUM Diterima
											</label>
										</div>
										<?php if($row2->berkas_fisik==1) { ?>
											<div id="catatan_berkas_<?php echo $row2->dokumen_id;?>"><?php echo "Diterima oleh " .$row2->penerima_berkas. " di " .$row2->sekolah. " tanggal " .$row2->tanggal_berkas; ?></div>
										<?php } ?>
									</td>
								</tr>
								<?php endforeach; ?>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="box box-solid">
				<div class="box-header with-border">
					<i class="glyphicon glyphicon-search text-info"></i>
					<h3 class="box-title text-info"><b>Verifikasi Data Siswa (Non DAPODIK)</b></h3>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<table class="table table-striped" style="margin-bottom:0px !important;">
								<tr >
									<td colspan="2">Untuk data siswa yang tidak bersumber dari data DAPODIK, mohon memastikan data-data berikut benar:</td>
								</tr>
								<tr >
									<td colspan="2"></td>
								</tr>
								<?php if ($row->asal_data == 0) { ?>
									...
									<input type="hidden" id="orig_catatan_nilai" name="orig_catatan_nilai" value="<?php echo $row->catatan_nilai; ?>">
									<tr >
										<td><b>Nilai Kelulusan / Nilai Ujian Nasional</b></td>
										<td style="width: 50%">
											<div class="form-group" style="margin-bottom: 10px;">
												<label style="margin-right: 10px;">
													<input type="radio" id="verifikasi_nilai" name="verifikasi_nilai" class="flat-green"<?php if($row->verifikasi_nilai==1){?> checked <?php }?> value="1" data-validation="required" data-validation-error-msg="Verifikasi data nilai kelulusan / nilai Ujian Nasional">
								...
								<?php } else { ?>
									...
									<input type="hidden" id="orig_catatan_profil" name="orig_catatan_profil" value="<?php echo $row->catatan_profil; ?>">
									<tr >
										<td><b>Identitas Siswa (Sesuai Akte dan Kartu Keluarga)</b></td>
										<td style="width: 50%">
											<div class="form-group" style="margin-bottom: 10px;">
												<label style="margin-right: 10px;">
													<input type="radio" id="verifikasi_profil" name="verifikasi_profil" class="flat-green"<?php if($row->verifikasi_profil==1){?> checked <?php }?> value="1" data-validation="required" data-validation-error-msg="Verifikasi data identitas">
									...
									<input type="hidden" id="orig_catatan_lokasi" name="orig_catatan_lokasi" value="<?php echo $row->catatan_lokasi; ?>">
									<tr >
										<td><b>Lokasi Rumah Siswa (Sesuai Kartu Keluarga atau Surat Domisili Apabila Ada)</b></td>
										<td style="width: 50%">
											<div class="form-group" style="margin-bottom: 10px;">
												<label style="margin-right: 10px;">
													<input type="radio" id="verifikasi_lokasi" name="verifikasi_lokasi" class="flat-green"<?php if($row->verifikasi_lokasi==1){?> checked <?php }?> value="1" data-validation="required" data-validation-error-msg="Verifikasi data lokasi rumah">
											...
											<textarea id="catatan_lokasi" name="catatan_lokasi" placeholder="Apabila belum benar, silahkan masukkan informasi yang perlu diperbaiki di sini." data-validation="" style="width: 100%; height: 80px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row->catatan_lokasi; ?></textarea>
											<?php if($row->verifikasi_lokasi==2) { ?>
												<textarea id="catatan_lokasi" name="catatan_lokasi" 
												placeholder="Apabila belum benar, silahkan masukkan informasi yang perlu diperbaiki di sini." data-validation="required" 
												data-validation-error-msg="Catatan verifikasi data lokasi rumah"
									...
									<?php } else { ?>
									<tr >
										<td><b>Data Inklusi / Kebutuhan Khusus</b></td>
										<td style="width: 50%">
											<div class="form-group" style="margin-bottom: 10px;">
												<label style="margin-right: 10px;">
													<input type="radio" id="verifikasi_inklusi" name="verifikasi_inklusi" class="flat-green"<?php if($row->verifikasi_inklusi==1){?> checked <?php }?> value="1" data-validation="required" data-validation-error-msg="Verifikasi data kebutuhan khusus">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="box box-solid">
				...
				<div class="box-footer">
					...
					<a href="<?php echo base_url();?>index.php/admin/verifikasisiswa" class="btn btn-info btn-flat pull-right">Batalkan Perubahan</a>
				</div>
			</div>
	</div>
</div>
...
<div class="bottom-right-menu" >
	<ul id='menu-list' class="menu-list">
      ...
      <div id="context-menu" href="#" class="btn bg-blue" aria-label="Quick context menu" style="cursor: auto;">
...
$(document).ready(function() {
	...
	$('#triwayat').DataTable({
        ...
        ajax: "<?php echo site_url('admin/verifikasisiswa/riwayat'); ?>?peserta_didik_id=<?php echo $peserta_didik_id; ?>",
        columns: [
	...
	$('#tprestasi').DataTable({
		...
		ajax: "<?php echo site_url('admin/verifikasisiswa/prestasi') . '?peserta_didik_id=' . $peserta_didik_id; ?>",
		"language": {
