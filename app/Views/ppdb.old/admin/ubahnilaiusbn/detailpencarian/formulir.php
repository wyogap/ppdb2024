...
<div class="row">
	<?php 
		...
		$ipa = 0;
		$nilai = 0;
		foreach($detailnilaiusbn->getResult() as $row):
			$nilai_usbn_id = $row->nilai_usbn_id;
			$bin = $row->bin;
			$mat = $row->mat;
			$ipa = $row->ipa;
			$nilai = $row->nilai;
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<div class="box box-solid">
			...
			<!-- <div class="box-footer">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form role="form" enctype="multipart/form-data" id="prosesubahnilaiusbn" action="<?php echo base_url();?>index.php/Cadmin/prosesubahnilaiusbn/" method="post">
							<input type="hidden" id="nilai_usbn_id" name="nilai_usbn_id" value="<?php echo $nilai_usbn_id;?>">
							<input type="hidden" id="peserta_didik_id" name="peserta_didik_id" value="<?php echo $peserta_didik_id;?>">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="form-group has-feedback">
										<label for="alamat">Bahasa Indonesia</label>
										<input type="number" step="any" class="form-control" id="bin" name="bin" placeholder="Bahasa Indonesia" min="0" max="100" value="<?php echo $bin;?>" data-validation="required">
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="form-group has-feedback">
										<label for="alamat">Matematika</label>
										<input type="number" step="any" class="form-control" id="mat" name="mat" placeholder="Matematika"  min="0" max="100" value="<?php echo $mat;?>" data-validation="required">
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<div class="form-group has-feedback">
										<label for="alamat">Ilmu Pengetahuan Alam</label>
										<input type="number" step="any" class="form-control" id="ipa" name="ipa" placeholder="Ilmu Pengetahuan Alam" min="0" max="100" value="<?php echo $ipa;?>" data-validation="required">
									</div>
								</div>
							</div>
							<button type="submit" class="btn btn-primary btn-flat">Update Nilai</button>
						</form>
					</div>
				</div>
			</div> -->
		...
		<form role="form" enctype="multipart/form-data" id="prosesubahnilaiusbn" action="<?php echo base_url();?>index.php/Cadmin/prosesubahnilaiusbn/" method="post">
			...
			<div class="box box-solid">
				<div class="box-header with-border">
					...
					<h3 class="box-title text-info"><b>Formulir Ubah Nilai USBN</b></h3>
				</div>
				<div class="box-body">
					<div class="row">
						<!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> -->
