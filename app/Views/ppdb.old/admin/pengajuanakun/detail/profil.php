				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="box box-solid">
						...
						<div class="box-footer">
							<form role="form" enctype="multipart/form-data" id="prosespengajuanakun" action="<?php echo base_url();?>index.php/Cadmin/prosespengajuanakun/" method="post">
								...
								<div class="form-group">
									<label>
										<input type="radio" id="approval" name="approval" class="flat-red" value="2" <?php if($row->approval==2) {?>checked<?php } ?> data-validation="required">
										Tidak Disetujui
									</label>
									<label>
										<input type="radio" id="approval" name="approval" class="flat-green" value="1" <?php if($row->approval==1) {?>checked<?php } ?> data-validation="required">
										Disetujui
									</label>
								</div>
