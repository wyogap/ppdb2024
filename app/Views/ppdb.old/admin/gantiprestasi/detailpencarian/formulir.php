	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<div class="box box-solid">
			...
			<!-- <div class="box-footer">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form role="form" enctype="multipart/form-data" id="prosesubahprestasi" action="<?php echo base_url();?>index.php/Cadmin/prosesubahprestasi/" method="post">
		...
		<form role="form" enctype="multipart/form-data" id="prosesubahprestasi" action="<?php echo base_url();?>index.php/Cadmin/prosesubahprestasi/" method="post">
			...
			<div class="box box-solid">
				<div class="box-header with-border">
					...
					<h3 class="box-title text-info"><b>Formulir Ganti Prestasi</b></h3>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
