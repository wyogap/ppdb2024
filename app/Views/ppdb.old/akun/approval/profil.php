				...
				<div class="row">
					<div class="box box-solid">
						...
						<div class="box-body">
							...
							<form role="form" enctype="multipart/form-data" id="ubahprofilsiswa" action="<?php echo base_url();?>index.php/akun/approval/ubahprofilsiswa" method="post">
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group has-feedback">
												...
												<input type="text" class="form-control" id="nisn" name="nisn" placeholder="NISN" minlength="10" maxlength="10" value="<?php echo $row->nisn; ?>">
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group has-feedback">
							...
							<form role="form" enctype="multipart/form-data" id="ubahalamatsiswa" action="<?php echo base_url();?>index.php/akun/approval/ubahalamatsiswa" method="post">
									<input type="hidden" id="pengguna_id" name="pengguna_id" value="<?php echo $row->peserta_didik_id;?>">
							<div class="box box-solid">
								<div class="box-header with-border">
							...
							<form role="form" enctype="multipart/form-data" id="ubahlokasirumah" action="<?php echo base_url();?>index.php/akun/approval/ubahlokasirumah" method="post">
									<input type="hidden" id="pengguna_id" name="pengguna_id" value="<?php echo $row->peserta_didik_id;?>">
							<div class="box box-solid">
								<div class="box-header with-border">
									...
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<table class="table table-striped" style="margin-bottom: 0px !important;">
												<tr>
													<td colspan="1">Untuk komunikasi dan klarifikasi, hubungi nomor berikut: <h3><b><?php echo $row->nomor_kontak; ?></b></h3>
													</td>
												</tr>
											</table>
										</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="box box-solid">
							...
							<div class="box-footer">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<form role="form" enctype="multipart/form-data" id="approveakun" action="<?php echo base_url();?>index.php/akun/approval/approve/" method="post">
											<input type="hidden" id="pengguna_id" name="pengguna_id" value="<?php echo $row->peserta_didik_id;?>">
