	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
		<div class="box box-primary box-solid">
			...
			<div class="box-footer with-border">
				...
				<a href="<?php echo base_url();?>index.php/sekolah/ubahdata?pendaftaran_id=<?php echo $row->pendaftaran_id;?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-edit"></i></a>			
				<a href="<?php echo base_url();?>index.php/sekolah/verifikasi/siswa?pendaftaran_id=<?php echo $row->pendaftaran_id;?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-ok"></i></a>				
