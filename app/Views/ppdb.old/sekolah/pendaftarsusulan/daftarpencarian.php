	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
		<div class="box box-primary box-solid">
			...
			<div class="box-footer with-border">
				<a href="<?php echo base_url();?>index.php/Csekolah/detailpendaftarsusulan?peserta_didik_id=<?php echo $row->peserta_didik_id;?>" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> Detail Siswa</a>
			</div>
		</div>
	</div>
	<?php endforeach;?>
