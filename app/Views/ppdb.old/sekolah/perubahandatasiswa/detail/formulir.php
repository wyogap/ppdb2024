...
<div class="row">
	...
	<?php endforeach;?>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<form role="form" enctype="multipart/form-data" id="prosesperubahandatasiswa" action="<?php echo base_url();?>index.php/Csekolah/prosesperubahandatasiswa/" method="post">
			<input type="hidden" id="peserta_didik_id" name="peserta_didik_id" value="<?php echo $peserta_didik_id;?>">
			<input type="hidden" id="kode_kabupaten_lama" name="kode_kabupaten_lama" value="<?php echo $kode_kabupaten;?>">
			<input type="hidden" id="kode_kecamatan_lama" name="kode_kecamatan_lama" value="<?php echo $kode_kecamatan;?>">
			<input type="hidden" id="kode_desa_lama" name="kode_desa_lama" value="<?php echo $kode_desa;?>">
			<input type="hidden" id="tanggal_lahir_lama" name="tanggal_lahir_lama" value="<?php echo $tanggal_lahir;?>">
			<input type="hidden" id="lintang_lama" name="lintang_lama" value="<?php echo $lintang;?>">
			<input type="hidden" id="bujur_lama" name="bujur_lama" value="<?php echo $bujur;?>">
			<div class="box box-solid">
				<div class="box-header with-border">
