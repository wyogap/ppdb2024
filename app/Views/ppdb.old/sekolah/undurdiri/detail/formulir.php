...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<?php foreach($detailpendaftar->getResult() as $row):?>
			<form role="form" enctype="multipart/form-data" id="prosesperubahandatasiswa" action="<?php echo base_url();?>index.php/Csekolah/prosesundurdiri/" method="post">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title text-info"><b>Formulir Undur Diri</b></h3>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group has-feedback">
								<label for="keterangan">Alasan Undur Diri</label>
								<textarea id="keterangan" name="keterangan" placeholder="Penjelasan terkait Undur Diri ..." data-validation="required" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="box-footer">
					<button type="submit" class="btn btn-danger btn-flat">Undur Diri</button>
				</div>
			</form>
			<?php endforeach;?>
		</div>
