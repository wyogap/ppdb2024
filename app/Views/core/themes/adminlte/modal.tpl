...
function showAjaxModal(url, header)
{
    ...
    jQuery('#scrollable-modal .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="{$base_url}assets/global/bg-pattern-light.svg" /></div>');
...
{
    // SHOWING AJAX PRELOADER IMAGE
    jQuery('#large-modal .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="{$base_url}assets/global/bg-pattern-light.svg" height = "50px" /></div>');
