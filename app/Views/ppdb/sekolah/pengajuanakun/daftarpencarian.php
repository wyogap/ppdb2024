	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<div class="box-header">
				<b>Hasil Pencarian: <?php echo count($daftar); ?> Akun</b>
			</div>
	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
		<div class="box box-primary box-solid">
			...
			<div class="box-footer with-border">
				<a href="<?php echo base_url();?>index.php/akun/approval?pengguna_id=<?php echo $row['peserta_didik_id'];?>&redirect=Csekolah/pengajuanakun" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> Detail Akun</a>
			</div>
		</div>
	</div>
