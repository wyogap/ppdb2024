	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="box box-solid">
			<!-- <div class="box-header with-border">
				...
				<h3 class="box-title"><b>Pencarian Pengajuan Akun</b></h3>
			</div> -->
			<div class="box-body">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="form-group has-feedback">
							<label for="approval">Persetujuan</label>
							<select id="approval" name="approval" class="form-control select2" style="width:100%;" value='0'>
								<option value="">--</option>
			...
			<div class="box-footer">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<a href="javascript:void(0)" onclick="carisiswa()" class="btn btn-primary btn-flat">Cari Pengajuan Akun</a>
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	function carisiswa(){
		var data = {nama:$("#nama").val(),jenis_kelamin:$("#jenis_kelamin").val(),tempat_lahir:$("#tempat_lahir").val(),tanggal_lahir:$("#tanggal_lahir").val(),approval:$("#approval").val()};
		$.ajax({
			type: "POST",
			url : "<?php echo site_url('Csekolah/caripengajuanakun')?>",
			data: data,
