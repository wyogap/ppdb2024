...
<div class="row">
	...
	<?php endforeach;?>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<form role="form" enctype="multipart/form-data" id="prosesperubahandatasiswa" action="<?php echo base_url();?>index.php/Csekolah/prosespendaftarsusulan/" method="post">
			<input type="hidden" id="peserta_didik_id" name="peserta_didik_id" value="<?php echo $peserta_didik_id;?>">
			<div class="box box-solid">
				<div class="box-header with-border">
					<i class="glyphicon glyphicon-edit text-info"></i>
					<h3 class="box-title text-info"><b>Formulir Pendaftar Susulan</b></h3>
				</div>
				<div class="box-body">
					Pendaftar Susulan akan otomatis diterima, mohon berhati-hati dalam memasukkan data.
				</div>
				<div class="box-footer">
					<button type="submit" class="btn btn-danger btn-flat">Registrasi Siswa</button>
				</div>
			</div>
		</form>
	</div>
