	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<div class="box box-solid">
			...
			<div class="box-footer">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form role="form" enctype="multipart/form-data" id="prosesubahpassword" action="<?php echo base_url();?>index.php/Cadmin/prosesubahpassword/" method="post">
							...
							<button type="submit" class="btn btn-warning btn-flat">Reset Password</button>
						</form>
					</div>
				</div>
			</div>
