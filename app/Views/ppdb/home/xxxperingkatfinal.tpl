				...
				<div class="container">
					<section class="content-header">
						...
						<h1 class="text-white pull-right">
							<a href="{$base_url}" class="text-white"><b>PPDB</b><?php echo $nama_tahun_ajaran_aktif; ?></a>
						</h1>
					</section>
                                                ...
                                                <table class="display" id="tdaftarpendaftar" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{$base_url}index.php/Chome/detailpendaftaran?peserta_didik_id=<?php echo $row->peserta_didik_id;?>" target="_blank"><?php echo $row->nama;?></a></td>
                                                            ...
                                                            <td class="text-end"><?php echo round($row->skor,2);?></td>
                                                ...
                                                <table class="display" id="t<?php echo $row->penerapan_id;?>" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php } ?>
                                                            ...
                                                            <td>
                                                            <a href="{$base_url}index.php/Chome/detailpendaftaran?peserta_didik_id=<?php echo $row2->peserta_didik_id;?>" target="_blank">
                                                                <?php echo $row2->nama;?>
                                                            </a>
                                                            </td>
