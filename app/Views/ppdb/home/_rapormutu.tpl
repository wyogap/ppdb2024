    ...
    $(document).ready(function() {
        ...
        $('#tnegeri').dataTable({
            ...
            columns: [
                ...
                { data: "a1_kemampuan_literasi", className: 'editable dt-body-center', 
                    width: "20%",
                },
                { data: "skor_kemampuan_literasi", className: 'editable dt-body-center', 
                    width: "20%", 
                },
                { data: "a2_kemampuan_numerasi", className: 'editable dt-body-center', 
                    width: "20%",
                },
                { data: "skor_kemampuan_numerasi", className: 'editable dt-body-center', 
                    width: "20%" 
                },
                { data: "a3_karakter", className: 'editable dt-body-center', 
                    width: "20%",
                },
