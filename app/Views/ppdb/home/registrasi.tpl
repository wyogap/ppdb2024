    ...
    {if !$cek_registrasi && !$cek_sosialisasi}
        <div class="alert alert-secondary" role="alert">
            <b>Registrasi siswa luar daerah dibuka dari tanggal <b><span class='tgl-indo'>{$waktu_registrasi.tanggal_mulai_aktif}</span></b> sampai dengan tanggal <b><span class='tgl-indo'>{$waktu_registrasi.tanggal_selesai_aktif}</span></b>.      
        </div>
    {else}
        {if $cek_sosialisasi}
        <div class="alert alert-secondary" role="alert">
        ...
        {else}
            {if !$do_registrasi|default: FALSE}
            ...
            <div id="formulir" {if !$do_registrasi|default: FALSE}style="display: none"{/if}>
