...
<div class="row page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Rapor Mutu Sekolah</a></li>
    </ol>
</div>
                    ...
                    <table class="display" id="tnegeri" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" data-priority="3"><span class="text-nowrap">Skor Akhir</span><br>(A+B+C)/9</th>
