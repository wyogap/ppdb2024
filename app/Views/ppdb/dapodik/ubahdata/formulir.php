...
<div class="row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<form role="form" enctype="multipart/form-data" id="prosesperubahandatasiswa" action="<?php echo base_url();?>index.php/dapodik/ubahdata/simpan?redirect=<?php echo $redirect; ?>" method="post">
