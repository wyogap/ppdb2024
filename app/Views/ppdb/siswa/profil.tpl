...
<div class="row" id="profil-dikunci-notif" style="display: none;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="alert alert-info alert-dismissible" role="alert">
            <i class="icon glyphicon glyphicon-info-sign"></i>Data profil kamu terkunci karena kamu sudah melakukan pendaftaran.
        </div>
    </div>
</div>
{/if}
                            ...
                            <tr id="row-dokumen-bdt" tcg-visible-tag='masuk_bdt'>
                                ...
                                <td>
                                    ...
                                    {else}
                                        ...
                                        <label for="unggah-profil-20" class="btn btn-primary" tcg-input-tag='afirmasi' tcg-input-false='show' tcg-input-true='hide'>Unggah</label>
                                        </span>
