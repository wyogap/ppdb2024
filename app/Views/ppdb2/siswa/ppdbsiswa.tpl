    ...
    ***********************************-->
    ...
    <script>
        ...
        (function($) {           
            ...
            //     let tag = card.attr("id");
            //     let flagval = konfirmasi[tag];
            //     if (flagval) {
            //         card.removeClass("status-danger");
            //         msg = card.find(".accordion-header-text .status").html('');
            //     }
            //     else {
            //         card.addClass("status-danger");
            //         msg = card.find(".accordion-header-text .status").html('Belum Benar');
            //     }

            // });

            //let els = $("[tcg-edit-action='konfirmasi']");
            ...
            editprestasi = new $.fn.dataTable.Editor( {
                ajax: "{$site_url}siswa/ppdb/prestasi",
                table: '#tbl-prestasi',
                idSrc: "prestasi_id",
                fields: [ 
                    {
            ...
            dtriwayat = $('#triwayat').DataTable({
                ...
                ajax: "{$site_url}siswa/ppdb/riwayat",
                columns: [
                    { data: "create_date", className: 'dt-body-center readonly-column', orderable: true },
