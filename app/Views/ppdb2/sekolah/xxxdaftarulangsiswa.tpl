			...
			<div class="content-wrapper">
				<div class="container">
					...
					<section class="content">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        ...
                                        <span class="pull-right"><a href="{$base_url}index.php/Chome/detailpendaftaran?peserta_didik_id=<?php echo $peserta_didik_id;?>" target="_blank" class="btn btn-primary btn-sm">Detail Pendaftaran</a></span>
                                    </div>
                                    <div class="box-body">
                                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="box box-solid">
                                        ...
                                        <div class="box-footer">
                                            <a href="{$base_url}index.php/sekolah/daftarulang/buktipendaftaran?peserta_didik_id=<?php echo $peserta_didik_id; ?>" class="btn bg-orange" target="_blank"><i class="glyphicon glyphicon-print"></i> Cetak Bukti Pendaftaran</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <form role="form" enctype="multipart/form-data" id="prosesverifikasiberkas" action="{$base_url}index.php/sekolah/daftarulang/prosesdaftarulang" method="post">
