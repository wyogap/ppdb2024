			...
			<div class="content-wrapper">
				<div class="container">
					...
					<section class="content">
                        ...
                        <form role="form" enctype="multipart/form-data" id="prosesverifikasiberkas" action="{$base_url}index.php/sekolah/verifikasi/prosesverifikasiberkas" method="post">
        ...
        function batal_perubahan() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    window.location.href = "{$base_url}index.php/sekolah/verifikasi";
                },
