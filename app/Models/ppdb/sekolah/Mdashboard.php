...
Class Mdashboard 
{
	...
	function dashboardline(){
		...
		where soft_delete=0 and cabut_berkas=0 and sekolah_id = '$sekolah_id'";
	...
	function dashboardpenerapan(){
		...
		select a.penerapan_id,a.nama AS jalur,d.kuota,
			(
				...
				where z.penerapan_id = a.penerapan_id and z.sekolah_id='$sekolah_id' and z.cabut_berkas=0 and z.soft_delete=0
	...
	function caripengajuanakun($nama, $jenis_kelamin, $tempat_lahir, $tanggal_lahir, $approval){
		...
		JOIN dbo_users b ON a.peserta_didik_id = b.pengguna_id AND b.soft_delete = 0
		";
	...
	**/
	...
	function tcg_daftar_siswa($sekolah_id, $tahun_ajaran_id) {
		...
		$query = "SELECT a.sekolah_id, b.nama as sekolah, 
					...
					where a.sekolah_id='$sekolah_id' and a.tahun_ajaran_id='$tahun_ajaran_id' and a.soft_delete=0";
	...
	function tcg_detil_pendaftaran($pendaftaran_id) {
		$sql = "select a.* from tcg_pendaftaran a where a.pendaftaran_id=$pendaftaran_id and a.soft_delete=0";
	...
	function tcg_pendaftaran($sekolah_id, $peserta_didik_id) {
		...
		$sql = "select a.* from tcg_pendaftaran a where a.sekolah_id='$sekolah_id' and a.peserta_didik_id='$peserta_didik_id' and a.soft_delete=0 and a.tahun_ajaran_id='$tahun_ajaran_id' and a.putaran='$putaran'";
	...
	function tcg_pendaftaran_penerapan_id($sekolah_id, $penerapan_id){
		...
		$sql = "select 
				...
				where a.sekolah_id='$sekolah_id' and a.penerapan_id=$penerapan_id and a.soft_delete=0 and a.tahun_ajaran_id='$tahun_ajaran_id' and a.putaran='$putaran'
