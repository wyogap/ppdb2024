...
Class Mtahapan
{
	...
	function tcg_tahapan($tahun_ajaran_id) {
		$query = "select a.*, b.nama as tahapan from cfg_waktu_pelaksanaan a
				  join ref_tahapan b on a.tahapan_id=b.tahapan_id and b.is_deleted=0
	...
	function tcg_update_tahapan($waktu_pelaksanaan_id, $key, $value) {
		$query = "update cfg_waktu_pelaksanaan set $key='$value' where waktu_pelaksanaan_id=$waktu_pelaksanaan_id";
		return $this->db->query($query);
	}
