...
class Rekappendaftar extends PpdbController {
	...
	function index()
	{
		...
		do {
            ...
            $data["rekappendaftar"] = $this->Msekolah->tcg_rekappendaftar($sekolah_id);
        ...
        //content template
        $data['content_template'] = 'rekappendaftar.tpl';

        $data['page_title'] = 'Rekapitulasi Pendaftar';
    ...
    function siswa() 
	{
        ...
        // var_dump($data['pendaftaran']); exit;
